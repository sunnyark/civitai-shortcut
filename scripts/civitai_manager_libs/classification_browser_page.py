...
def on_sc_nextPage_btn_click(sc_types, sc_search, sc_basemodels, sc_classifications, show_downloaded_sc, ex_shortcuts , show_ex_shortcuts, sc_page, columns, rows):
    sc_page = sc_page + 1
    thumb_list , thumb_totals, thumb_max_page  = get_thumbnail_list(sc_types,show_downloaded_sc,sc_search,sc_basemodels,sc_classifications,sc_page, columns, rows, ex_shortcuts if show_ex_shortcuts else None)
...
def on_sc_prevPage_btn_click(sc_types, sc_search, sc_basemodels, sc_classifications, show_downloaded_sc, ex_shortcuts , show_ex_shortcuts, sc_page, columns, rows):
    sc_page = sc_page - 1
    if sc_page < 1:
        sc_page = 1    
    thumb_list , thumb_totals, thumb_max_page  = get_thumbnail_list(sc_types,show_downloaded_sc,sc_search,sc_basemodels,sc_classifications,sc_page, columns, rows, ex_shortcuts if show_ex_shortcuts else None)
