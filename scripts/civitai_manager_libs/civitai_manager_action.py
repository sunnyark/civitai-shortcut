                ...
                for file,path in file_list.items():                    
                    ...
                    if vinfo:                      
                        try:  
                            if info != "":
                                info = info + "\n"
                            info = info + f"{vinfo['name']}"
                        except:
                            pass
                    
                return gr.Row.update(visible = True),gr.Textbox.update(value=info)
            
    return gr.Row.update(visible = False),gr.Textbox.update(value="")
